...
inherit autotools bash-completion-r1 flag-o-matic multibuild pax-utils toolchain-funcs versionator git-r3

EGIT_REPO_URI="https://github.com/zaolin/TrustedGRUB2.git"
